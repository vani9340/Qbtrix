<script>
    ...
    .btn-gradient-2 {
      background: linear-gradient(#101010,#242424) padding-box,
                  linear-gradient(to right, #F2531E 0%, #FACF4B 18.23%, #7ACE46 41.67%, #5392FA 60.42%, #785EFA 80.73%, #F64CD5 100%) border-box;
      border-radius: 24px;
      border: 6px solid transparent;
    
    }
    .btn{background: linear-gradient(180deg, #252525 0%, #101010 100%);
    ...
    <div class='bg-[#292929] min-h-[509px] w-screen flex flex-col items-center justify-center'>
        ...
        <!-- logo -->
        <div class='flex justify-center items-center mt-[44.38px] gap-[20px]'>
            ...
            <a target = "blank" href="https://www.linkedin.com"><img src={link} alt='img'/></a>
